  ...
  return (
    <div className="min-h-[100dvh] flex items-center justify-center p-4 relative overflow-hidden bg-slate-50 dark:bg-slate-950 transition-colors duration-500">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute -top-[30%] -right-[10%] w-[70vw] h-[70vw] rounded-full bg-emerald-400/20 dark:bg-emerald-600/20 blur-[100px] animate-pulse"></div>
        <div className="absolute -bottom-[20%] -left-[20%] w-[60vw] h-[60vw] rounded-full bg-teal-400/20 dark:bg-teal-600/20 blur-[120px] animate-pulse" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-[40%] left-[20%] w-[40vw] h-[40vw] rounded-full bg-emerald-200/40 dark:bg-emerald-400/10 blur-[80px] animate-pulse" style={{ animationDelay: '4s' }}></div>
      </div>
        ...
        <div className="bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl rounded-[2.5rem] p-8 sm:p-10 border border-slate-200 dark:border-white/10 shadow-2xl dark:shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden transition-colors duration-500">
          ...
          <div className="flex flex-col items-center text-center gap-4 mb-8">
            <div className="relative group cursor-default">
              <div className="absolute inset-0 bg-emerald-400 rounded-2xl blur-md opacity-30 dark:opacity-40 group-hover:opacity-50 dark:group-hover:opacity-60 transition-opacity duration-500"></div>
              <div className="relative w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 dark:from-emerald-400 dark:to-teal-600 flex items-center justify-center text-white shadow-lg transform transition-transform duration-300 group-hover:scale-105 group-hover:-rotate-3">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-5">
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-slate-600 dark:text-slate-300 uppercase tracking-wider ml-1 transition-colors">Correo Electrónico</label>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center ml-1">
                <label className="text-xs font-bold text-slate-600 dark:text-slate-300 uppercase tracking-wider transition-colors">Contraseña</label>
                <a href="#" className="text-xs font-semibold text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 dark:hover:text-emerald-300 transition-colors">
                  ¿Olvidada?
                </a>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-12 py-3.5 rounded-2xl border border-slate-200 dark:border-none bg-slate-50 dark:bg-white/5 text-sm text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:bg-white dark:focus:bg-white/10 focus:ring-2 focus:ring-emerald-500/50 transition-all outline-none"
                />
                <button
                  type="button"
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-slate-500 dark:text-slate-400 transition-colors">
              ¿Eres nuevo por aquí?{' '}
              <Link href="/registro" className="font-bold text-slate-900 dark:text-white hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors underline decoration-emerald-500/30 hover:decoration-emerald-500/80 dark:hover:decoration-emerald-400 underline-offset-4">
                Crea tu cuenta
              </Link>
            </p>
          </div>
